            ...
            <Grid container spacing={4}>
                <Grid item xs={12} sm={12} md={12} lg={3} xl={3} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                    <div style={styles.ourServicesImageContainer}>
                        <img src={images.delivery} style={styles.ourServicesImage} alt="EZ Delivery"/>
                    </div>
                ...
                <Grid item xs={12} sm={12} md={12} lg={3} xl={3} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                    <div style={styles.ourServicesImageContainer}>
                        <img src={images.purchase} style={styles.ourServicesImage} alt="EZ Tracking" />
                    </div>
                    <Typography variant="h5">
                        代购
                    </Typography>
                ...
                <Grid item xs={12} sm={12} md={12} lg={3} xl={3} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                    <div style={styles.ourServicesImageContainer}>
                        <img src={images.pay} style={styles.ourServicesImage}  alt="EZ Service" />
                    </div>
                    <Typography variant="h5">
                        代付
                    </Typography>
                ...
                <Grid item xs={12} sm={12} md={12} lg={3} xl={3} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                    <div style={styles.ourServicesImageContainer}>
                        <img src={images.search} style={styles.ourServicesImage}  alt="EZ Service"/>
                    </div>
                    <Typography variant="h5">
                        木架与验货
                    </Typography>
