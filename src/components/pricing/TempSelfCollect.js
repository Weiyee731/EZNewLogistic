            ...
            >
                <TableContainer component={Paper}>
                    <Table sx={{ minWidth: 650 }} aria-Typography="simple table">
                        ...
                        <TableBody>
                            {data.map((tablecell, index) => (
                                <TableRow >
                                    {
                                        index === 0 &&
                                        <TableCell rowSpan={3} align="center" style={styles.columnHeader}>
                                            海运收费
                                        </TableCell>
                                    }
                        ...
                        <TableBody >
                            <TableCell align="center" style={styles.columnHeader}>时效</TableCell>
                        ...
                        <TableBody >
                            <TableCell align="center" style={styles.columnHeader}>清关</TableCell>
                            <TableCell colSpan={3} style={{ textAlign: "center", letterSpacing: 2 }}>派送服务收费会以派送地点为准，收费服务只送到楼下门口，不包括搬上楼或搬进屋</TableCell>
                        </TableBody>
                        <TableBody >
                            <TableCell align="center" style={styles.columnHeader}>派送服务</TableCell>
                        ...
                        <TableBody >
                            <TableCell align="center" style={styles.columnHeader}>叉车收费</TableCell>
                            <TableCell colSpan={3} style={{ textAlign: "center" }}>
                        ...
                        <TableBody >
                            <TableCell align="center" style={styles.columnHeader}>立方计算</TableCell>
                            <TableCell colSpan={3} style={{ textAlign: "center" }}>
                        ...
                        <TableBody >
                            <TableCell align="center" style={styles.columnHeader}>违禁物品</TableCell>
                            <TableCell colSpan={3} style={{ textAlign: "center" }}>
                        ...
                        <TableBody >
                            <TableCell align="center" style={styles.columnHeader}>重量限制</TableCell>
                            <TableCell colSpan={3} style={{ textAlign: "center" }}>
...
const styles = {
    columnHeader: {
        ...
        boxShadow: '5px 5px 15px 5px rgba(22, 22, 22, 0.15)',
    }
}